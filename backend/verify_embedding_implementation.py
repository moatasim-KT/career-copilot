...
def verify_imports():
    ...
    try:
        ...
        # Integration service
        from app.services.contract_embedding_integration import (
            ContractEmbeddingIntegrationService,
            get_contract_embedding_integration_service
        )
        print("✅ ContractEmbeddingIntegrationService imports successful")
        
        # Repositories
        from app.repositories.contract_embedding_repository import (
            ContractEmbeddingRepository,
            SimilaritySearchLogRepository
        )
