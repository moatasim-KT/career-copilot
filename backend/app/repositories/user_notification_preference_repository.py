...
class UserNotificationPreferenceRepository(BaseRepository):
	...
	async def create_preference(self, user_id: UUID, notification_type: str, channel_id: str, is_enabled: bool = True) -> UserNotificationPreference:
	...
	async def get_preference(self, user_id: UUID, notification_type: str) -> Optional[UserNotificationPreference]:
