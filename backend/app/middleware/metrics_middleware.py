...
contract_analysis_duration_seconds = Histogram(
    ...
    buckets=(10, 30, 60, 90, 120, 180, 240, 300)
)

contract_analysis_total = Counter(
    'contract_analysis_total',
    'Total contract analyses',
    ['status']
)

contract_analysis_failures_total = Counter(
    'contract_analysis_failures_total',
    'Total job application tracking failures',
    ['error_type']
)
...
ai_service_rate_limit_errors_total = Counter(
    'ai_service_rate_limit_errors_total',
    'Total AI service rate limit errors',
    ['provider']
)
