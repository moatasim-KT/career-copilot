...
class EnhancedSlackService:
    ...
    async def send_message(self, message: SlackMessage) -> Dict[str, Any]:
        ...
        if not await self._validate_channel_access(message.channel):
            raise EmailServiceError(
                f"Access denied to channel: {message.channel}",
        ...
        try:
            ...
            raise EmailServiceError(
                f"Slack message delivery failed: {e}",
        ...
        blocks = [
            {
                ...
                "text": {
                    "type": "plain_text",
                    "text": f"📋 Contract Analysis Complete: {contract_name}"
                }
            },
            {
                "type": "section",
                "fields": [
                    {
                        "type": "mrkdwn",
                        "text": f"*Risk Score:* {risk_score}/10"
                    },
                    {
                        "type": "mrkdwn",
            ...
            },
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": f"*Summary:* {analysis_summary}"
                }
            }
        ]
        ...
        blocks = [
            {
                ...
                "text": {
                    "type": "plain_text",
                    "text": f"{emoji} {alert_level} RISK ALERT"
                }
            },
            {
                "type": "section",
    ...
    async def upload_contract_file(
        ...
        try:
            ...
            comment_parts.extend([
                "",
                "Use the buttons below to interact with this contract:",
                "• 🔍 Analyze contract",
                "• 📄 Generate report", 
                "• ⚠️ Check for risks"
            ])
            ...
            raise EmailServiceError(
                f"Contract file upload failed: {e}",
                category=ErrorCategory.EXTERNAL_SERVICE,
                severity=ErrorSeverity.HIGH
            )
    
    async def send_contract_action_buttons(
        self,
        channel: str,
        contract_name: str,
        file_id: str,
        ...
        blocks = [
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": f"🔧 *Contract Actions for {contract_name}*\nChoose an action to perform:"
                }
            },
            {
                "type": "actions",
                ...
                "elements": [
                    {
                        ...
                        "confirm": {
                            ...
                            "text": {
                                "type": "mrkdwn",
                                "text": f"Are you sure you want to approve *{contract_name}*?"
                            },
                            "confirm": {
                                "type": "plain_text",
                                "text": "Yes, Approve"
                    ...
                    },
                    {
                        ...
                        "confirm": {
                            ...
                            "text": {
                                "type": "mrkdwn",
                                "text": f"Are you sure you want to reject *{contract_name}*?"
                            },
                            "confirm": {
                                "type": "plain_text",
                                "text": "Yes, Reject"
    ...
    async def create_approval_workflow(
        ...
        try:
            ...
            blocks = [
                {
                    ...
                    "text": {
                        "type": "plain_text",
                        "text": f"📋 Approval Required: {contract_name}"
                    }
                },
                {
                    "type": "section",
            ...
            raise EmailServiceError(
                f"Approval workflow creation failed: {e}",
                category=ErrorCategory.EXTERNAL_SERVICE,
                severity=ErrorSeverity.HIGH
            )
            ...
            blocks=payload["message"]["blocks"] + [
                {
                    ...
                    "elements": [
                        {
                            "type": "mrkdwn",
                            "text": f"👤 <@{user_id}> is reviewing this contract"
                        }
                    ]
                }
            ]
    ...
    async def _handle_analyze_contract(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        asyncio.create_task(self._simulate_contract_analysis_from_button(
            contract_name, file_id, user_id, payload["channel"]["id"]
        ))
            ...
            blocks=payload["message"]["blocks"] + [
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": f"✅ *APPROVED* by <@{user_id}> at {datetime.now().strftime('%Y-%m-%d %H:%M')}"
                    }
                },
                {
                    "type": "context",
                    "elements": [
                        {
                            "type": "mrkdwn",
                            "text": "Contract has been approved and is ready for execution."
                        }
                    ]
                }
            ]
            ...
            blocks=payload["message"]["blocks"] + [
                {
                    ...
                    "text": {
                        "type": "mrkdwn",
                        "text": f"❌ *REJECTED* by <@{user_id}> at {datetime.now().strftime('%Y-%m-%d %H:%M')}"
                    }
                },
                {
                    "type": "context",
                    "elements": [
                        {
                            "type": "mrkdwn",
                            "text": "Contract has been rejected. Please review and address concerns."
                        }
                    ]
                }
            ]
                ...
                "blocks": [
                    ...
                    },
                    {
                        ...
                        "element": {
                            ...
                            "placeholder": {
                                "type": "plain_text",
                                "text": "Describe the specific changes needed..."
                            }
                        },
                        "label": {
                            "type": "plain_text",
                        ...
                        "element": {
                            ...
                            "options": [
                                ...
                                },
                                {
                                    "text": {
                                        "type": "plain_text",
                                        "text": "High - Significant revisions"
                                    },
                                    "value": "high"
                                }
                            ]
    ...
    async def _handle_workflow_approve(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if user_id not in workflow["approvers"]:
            await self.client.chat_postEphemeral(
                channel=payload["channel"]["id"],
                user=user_id,
                text="❌ You are not authorized to approve this contract."
            )
        ...
        if user_id in workflow["approved_by"]:
            await self.client.chat_postEphemeral(
                channel=payload["channel"]["id"],
                user=user_id,
                text="ℹ️ You have already approved this contract."
            )
                ...
                "blocks": [
                    {
                        ...
                        "element": {
                            ...
                            "placeholder": {
                                "type": "plain_text",
                                "text": "Add your comment about this contract..."
                            }
                        },
                        "label": {
                            "type": "plain_text",
    ...
    async def _simulate_contract_analysis_from_button(
        self,
        contract_name: str,
        file_id: str,
        user_id: str,
            ...
            blocks = [
                {
                    ...
                    "text": {
                        "type": "plain_text",
                        "text": f"📋 Approval Required: {workflow['contract_name']}"
                    }
                },
                {
                    "type": "section",
