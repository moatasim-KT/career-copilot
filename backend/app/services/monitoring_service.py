...
class ServiceMonitoringService:
    ...
    def _setup_default_services(self):
        ...
        # Internal services
        self.add_service(ServiceEndpoint(
            name="backend_health",
        ...
        self.add_service(ServiceEndpoint(
            ...
            url="http://localhost:8001/api/v1/health/detailed",
            timeout=10
        ))
        ...
        self.add_service(ServiceEndpoint(
            name="logging_health",
            url="http://localhost:8001/api/v1/health/logging",
            timeout=5
        ))
        ...
        self.add_service(ServiceEndpoint(
            ...
            url="http://localhost:8001/api/v1/health/services",
            timeout=10
        ))
    ...
    def get_service_summary(self) -> Dict[str, Dict]:
        ...
        for service_name, history in self.status_history.items():
            ...
            recent_checks = [
                s for s in history 
                if s.last_check and s.last_check > datetime.utcnow() - timedelta(hours=24)
            ]
