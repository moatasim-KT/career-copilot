...
class ChromaDBConnectionPool:
    ...
    async def _perform_health_checks(self):
        ...
        async with self._lock:
            ...
            self._stats.uptime = datetime.utcnow() - self._start_time
...
class ChromaDBClient:
    ...
    async def get_or_create_collection(
        ...
        async with self.connection_pool.get_connection() as connection:
            try:
                ...
                collection = connection.client.get_collection(
                    name=name,
                ...
                collection = connection.client.create_collection(
                    name=name,
                    embedding_function=self.embedding_function,
                    metadata=metadata
                )
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "embedding_function": {
                "type": type(self.embedding_function).__name__,
                "available": self.embedding_function is not None
            },
            "timestamp": datetime.utcnow().isoformat()
        }
