...
class UserSettingsService:
	...
	async def update_user_settings(self, user_id: UUID, settings_update: UserSettingsUpdate) -> Optional[UserSettingsResponse]:
		"""
	...
	async def update_profile(self, user_id: UUID, username: Optional[str] = None, email: Optional[str] = None) -> bool:
		"""
	...
	async def update_integration_setting(self, user_id: UUID, integration_name: str, setting_key: str, setting_value: any) -> bool:
		"""
		...
		try:
			...
			async with db_manager.get_session() as session:
				...
				updated_settings = await settings_repo.update_integration_setting(user_id, integration_name, setting_key, setting_value)
	...
	def _validate_risk_thresholds(self, update_data: Dict, current_settings: Optional[DBUserSettings]) -> bool:
