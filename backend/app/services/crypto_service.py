...
class CryptoService:
	...
	def encrypt_text(self, plaintext: str) -> str:
		...
		try:
			...
			raise ValueError(f"Failed to encrypt text: {e!s}")
	...
	def decrypt_text(self, encrypted_text: str) -> str:
		...
		try:
			...
			raise ValueError(f"Failed to decrypt text: {e!s}")
	...
	def encrypt_json(self, data: Dict[Any, Any]) -> str:
		...
		try:
			...
			raise ValueError(f"Failed to encrypt JSON: {e!s}")
	...
	def decrypt_json(self, encrypted_json: str) -> Dict[Any, Any]:
		...
		try:
			...
			raise ValueError(f"Failed to decrypt JSON: {e!s}")
	...
	def encrypt_file(self, file_data: bytes) -> bytes:
		...
		try:
			...
			raise ValueError(f"Failed to encrypt file: {e!s}")
	...
	def decrypt_file(self, encrypted_data: bytes) -> bytes:
		...
		try:
			...
			raise ValueError(f"Failed to decrypt file: {e!s}")
	...
	def decrypt_user_profile(self, encrypted_profile: str) -> Dict[Any, Any]:
		...
		try:
			...
			raise ValueError(f"Failed to decrypt user profile: {e!s}")
