...
class ApplicationService:
    ...
    def get_application(self, application_id: int, user_id: int) -> Optional[JobApplication]:
    ...
    def get_applications_using_document(self, document_id: int, user_id: int) -> List[JobApplication]:
        ...
        applications = self.db.query(JobApplication).filter(
            and_(
                JobApplication.user_id == user_id,
                JobApplication.documents.op('?')([{"document_id": document_id}])
            )
        ).all()
