...
class FeedbackAnalysisService:
    ...
    def _analyze_temporal_patterns(self, feedback_data: List[JobRecommendationFeedback]) -> Dict[str, Any]:
        ...
        return {
            ...
            "satisfaction_trend": "improving" if len(satisfaction_rates) > 1 and satisfaction_rates[-1] > satisfaction_rates[0] else "declining" if len(satisfaction_rates) > 1 else "stable"
        }
        ...
        if location_analysis:
            ...
            if remote_match and no_match:
                ...
                if remote_satisfaction > 0.9 and no_match_satisfaction < 0.3:
                    ...
                    adjustments.append({
                        "weight": "location_matching",
                        "change": +10,
                        "reason": f"Location matching shows strong correlation with satisfaction"
                    })
