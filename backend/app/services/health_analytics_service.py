...
class HealthAnalyticsService:
    ...
    async def record_health_check(self, health_result: Dict[str, Any]) -> None:
        ...
        try:
            ...
            if self.last_status != overall_status:
                ...
                if (self.last_status == HealthStatus.HEALTHY and 
                    overall_status in [HealthStatus.DEGRADED, HealthStatus.UNHEALTHY]):
    ...
    async def get_health_summary(self, hours: int = 24) -> HealthSummary:
        ...
        try:
            ...
            period_metrics = [
                metric for metric in self.health_history
            ...
            period_incidents = [
                ...
                if start_time <= datetime.fromisoformat(incident["start_time"]) <= end_time
            ]
    ...
    async def get_component_analytics(self, component: str, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            ...
            period_metrics = [
                metric for metric in component_history
                if start_time <= metric.timestamp <= end_time
            ]
            ...
            return {
                ...
                "recent_errors": [
                    ...
                    for m in period_metrics[-10:] if m.error  # Last 10 errors
                ]
            }
    ...
    async def get_availability_report(self, hours: int = 24) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "incidents": {
                    "total_count": len(summary.incidents),
    ...
    async def _record_incident(
        ...
        try:
            incident = {
                ...
                "affected_components": [
                    name for name, data in health_result.get("components", {}).items()
