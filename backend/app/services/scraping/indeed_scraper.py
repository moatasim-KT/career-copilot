...
class IndeedScraper(BaseScraper):
	...
	def _parse_job_listing(self, job_element) -> Optional[Dict[str, Any]]:
		...
		try:
			...
			# Extract job title
			title_selectors = ["h2.jobTitle a span", '[data-testid="job-title"] a span', ".jobTitle a", "h2 a span[title]"]
			...
			company_selectors = ['[data-testid="company-name"]', ".companyName", "span.companyName a", "span.companyName"]
			...
			# Extract location
			location_selectors = ['[data-testid="job-location"]', ".companyLocation", "div.companyLocation"]
			...
			salary_selectors = [".salary-snippet", '[data-testid="job-salary"]', ".salaryText"]
			...
			# Extract job URL
			url_selectors = ["h2.jobTitle a", '[data-testid="job-title"] a', "h2 a"]
			...
			snippet_selectors = [".job-snippet", '[data-testid="job-snippet"]', ".summary"]
