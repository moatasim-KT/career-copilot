...
class AnalysisBackupIntegration:
    ...
    async def restore_analysis_by_id(
        self,
        analysis_id: str,
        user_id: str
        ...
        try:
            ...
            for backup in backups:
                ...
                if analysis_id in backup.get("name", ""):
                    restored_data = await self.storage_manager.restore_contract_analysis(
        ...
        try:
            ...
            if analysis_backup:
                ...
                return {
                    "analysis_id": analysis_id,
                    "backup_exists": False,
                    "message": "No backup found for this analysis"
                }
    ...
    async def cleanup_user_backups(self, user_id: str, force: bool = False) -> Dict[str, int]:
        ...
        """
        try:
            result = await self.storage_manager.cleanup_old_backups(
                user_id=user_id,
                force_cleanup=force
            )
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "backup_integration_status": "unhealthy",
                "error": str(e),
                "timestamp": datetime.now().isoformat()
            }
