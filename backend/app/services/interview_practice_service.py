...
from app.models.interview import InterviewSession, InterviewQuestion, InterviewType, InterviewStatus
...
class InterviewPracticeService:
    ...
    async def evaluate_answer(self, question_id: int) -> InterviewQuestionResponse:
        ...
        cached_feedback = cache_service.get_cached_interview_feedback(
        ...
        if cached_feedback:
            ...
            try:
                ...
                cache_service.cache_interview_feedback(
                    question.question_text, question.answer_text, feedback_data, ttl=3600
                )
