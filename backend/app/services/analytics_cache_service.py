...
class AnalyticsCacheService:
	...
	def set(self, key: str, value: Any, ttl: timedelta = timedelta(minutes=5)) -> bool:
		"""
	...
	def get_stats(self) -> dict:
		...
		"""
		stats = {"backend": "redis" if self.redis_client else "memory", "memory_cache_size": len(self._memory_cache)}
...
def get_analytics_cache(redis_url: Optional[str] = None) -> AnalyticsCacheService:
	...
	if _cache_service is None:
		# Resolve redis_url from settings or environment if not explicitly provided
