...
class ContentQualityService:
    ...
    def analyze_content_quality(
        ...
        try:
            ...
            suggestions = self._generate_suggestions(
                content, readability_score, grammar_score, structure_score,
                keyword_relevance_score, length_score, tone_consistency_score
            )
    ...
    def _calculate_length_score(self, content: str, content_type: str) -> float:
        ...
        optimal_ranges = {
            'cover_letter': (200, 400),
            'email_template': (50, 150),
            'resume_tailoring': (100, 300)
        }
