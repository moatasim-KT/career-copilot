...
TECH_SKILLS = {
    ...
    "swift", "kotlin", "scala", "r", "matlab", "sql", "bash", "shell", "powershell",
    ...
    "lightgbm", "catboost", "spacy", "nltk", "opencv", "matplotlib", "seaborn", "plotly",
    "jupyter", "tableau", "power bi", "looker", "spark", "hadoop", "airflow",
    ...
    "testing", "unit testing", "pytest", "jest", "selenium", "automation"
}
...
class SkillMatchingService:
    ...
    def match_skills(
        ...
        skill_categories = self._categorize_missing_skills(
            missing_skills, 
            job_title
        ) if job_title else {}
    ...
    def extract_skills(
        ...
        if include_soft_skills:
            soft_skills = {
                ...
                "attention to detail", "collaboration", "analytical", "strategic thinking"
            }
            ...
            for skill in common_skills:
                if skill not in current_skills_norm:
                    suggestions.append({
                        ...
                        "priority": "medium",
                        "category": "general",
                        "reason": "Widely used across technical roles"
                    })
        ...
        for skill in role_profile.get("required", []):
            if skill not in current_skills_norm:
                suggestions.append({
                    ...
                    "priority": "high",
                    "category": "required",
                    "reason": f"Essential for {target_role} roles"
                })
        ...
        for skill in role_profile.get("preferred", []):
            if skill not in current_skills_norm:
                suggestions.append({
                    ...
                    "priority": "medium",
                    "category": "preferred",
                    "reason": f"Commonly requested for {target_role} positions"
                })
        ...
        for skill in role_profile.get("nice_to_have", []):
            if skill not in current_skills_norm:
                suggestions.append({
                    ...
                    "reason": f"Gives you an edge in {target_role} applications"
                })
    ...
    def calculate_skill_gap(
        ...
        try:
            ...
            # Add learning path
            learning_path = self.suggest_skills(
