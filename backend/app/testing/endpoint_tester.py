...
class EndpointTester:
            ...
            try:
                ...
                self.test_results.append(
                    TestResult(
                        ...
                        status_code=0,
                        response_time=0,
                        error_message=f"Failed to test endpoint: {str(e)}",
                    )
                )
            ...
            try:
                ...
                if endpoint.response_model:
                    try:
                        ...
                        result.add_error(f"Response validation failed: {str(e)}")
                    except Exception as e:
                        result.add_warning(f"Could not validate response: {str(e)}")
    ...
    def generate_test_report(self, output_format: str = "dict") -> Any:
        """
...
"""
    ...
    def export_results_to_html(self, filepath: str):
        """
