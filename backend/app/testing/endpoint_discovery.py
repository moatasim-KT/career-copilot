...
class ParameterInfo:
    ...
    def __repr__(self) -> str:
        ...
        return f"<Parameter {self.name}: {self.type_annotation.__name__} ({self.location.value}, {req_str})>"
...
class EndpointDiscovery:
    ...
    def discover_endpoints(self) -> List[EndpointInfo]:
        ...
        Returns:
            List of EndpointInfo objects containing metadata for each endpoint
        """
        self._endpoints = []
    ...
    def _extract_endpoint_info(self, route: APIRoute) -> EndpointInfo:
        ...
        method = list(methods)[0]  # Take the first method
    ...
    def _determine_parameter_location(self, param_name: str, type_annotation: Type, route: APIRoute) -> Optional[ParameterLocation]:
        ...
        Returns:
            ParameterLocation enum value or None
        """
    ...
    def _extract_request_body_model(self, route: APIRoute) -> Optional[Type[BaseModel]]:
        ...
        Returns:
            The Pydantic model class or None
        """
        endpoint_func = route.endpoint
        sig = inspect.signature(endpoint_func)
