    ...
    def log_with_correlation(
        ...
        **metadata
        ...
        logger.log(
            ...
            extra={"correlation_data": log_data}
        )
        ...
        **context_data
        ...
        try:
            ...
            self.log_with_correlation(
                "ERROR",
                f"Operation failed: {operation or 'unknown'}",
                error=e
            )
            raise
...
def log_with_correlation(
    ...
    **metadata
    ...
    """Log message with correlation information."""
    get_correlation_manager().log_with_correlation(
        level=level,
        message=message,
        operation=operation,
        component=component,
...
async def correlation_context(
    ...
    **context_data
    ...
    """Async context manager for correlation tracking."""
    async with get_correlation_manager().correlation_context(
        correlation_id=correlation_id,
        operation=operation,
        **context_data
    ) as context:
