...
class IAMManager:
    ...
    def _initialize_role_permissions(self) -> Dict[Role, Set[Permission]]:
        ...
        return {
            Role.ADMIN: {
                ...
                Permission.CREATE_JOB, Permission.READ_JOB, Permission.UPDATE_JOB, Permission.DELETE_JOB,
                Permission.READ_ANALYTICS, Permission.CREATE_REPORT,
                Permission.MANAGE_SYSTEM, Permission.VIEW_LOGS, Permission.MANAGE_ROLES,
                Permission.API_ACCESS, Permission.ADMIN_API_ACCESS
            },
            Role.MANAGER: {
            ...
            Role.USER: {
                Permission.READ_USER, Permission.UPDATE_USER,
                Permission.CREATE_JOB, Permission.READ_JOB, Permission.UPDATE_JOB,
                Permission.API_ACCESS
            },
            Role.READONLY: {
                Permission.READ_USER, Permission.READ_JOB, Permission.READ_ANALYTICS,
                Permission.API_ACCESS
            },
            Role.SERVICE: {
                Permission.API_ACCESS, Permission.READ_JOB, Permission.CREATE_JOB, Permission.UPDATE_JOB
            }
        }
    ...
    def update_service_account_usage(self, name: str):
        ...
        if name in self._service_accounts:
            self._service_accounts[name].last_used = datetime.utcnow()
