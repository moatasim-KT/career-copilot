...
from .exceptions import ErrorSeverity, ErrorCategory, ContractAnalysisError
...
class ErrorTrackingSystem:
    ...
    def _setup_default_pattern_detectors(self):
        ...
        self.pattern_detectors.extend([
            self._detect_recurring_errors,
            self._detect_error_spikes,
            self._detect_cascading_errors,
            self._detect_critical_path_errors
        ])
    ...
    def track_error(
        ...
        with self._lock:
            ...
            if signature_str in self.tracked_errors:
                ...
                tracked_error.last_occurrence = datetime.utcnow()
    ...
    def _create_error_signature(self, error: Exception, component: str) -> ErrorSignature:
        ...
        stack_hash = hashlib.md5(relevant_stack.encode()).hexdigest()
    ...
    def _detect_critical_path_errors(self) -> Dict[str, List[ErrorPattern]]:
        ...
        critical_components = [
            "contract_analysis", "authentication", "database",
            "file_processing", "api_gateway"
        ]
    ...
    def get_error_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "detected_patterns": {
                signature: [p.value for p in patterns]
                for signature, patterns in self.detected_patterns.items()
            },
    ...
    def resolve_error(self, signature: str, resolution_notes: str = None):
    ...
    def cleanup_old_errors(self):
        ...
        to_remove = []
        for signature, tracked_error in self.tracked_errors.items():
            if (tracked_error.resolution_status == "resolved" and 
                tracked_error.last_occurrence < cutoff_date):
