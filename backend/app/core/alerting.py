...
def initialize_default_alert_rules():
    ...
    default_rules = [
        ...
        AlertRule(
            ...
            severity=AlertSeverity.MEDIUM,
            description="Processing queue has large backlog"
        ),
        AlertRule(
        ...
        AlertRule(
            ...
            condition="backup_failures > 0",
            severity=AlertSeverity.HIGH,
            description="Backup process failures detected"
        ),
        AlertRule(
...
def create_alert(name: str, message: str, severity: AlertSeverity, details: Dict[str, Any] = None):
    """Create a new alert."""
    alert = {
        "name": name,
        "message": message,
