...
class EnvironmentConfigManager:
	...
	def _detect_environment(self) -> Environment:
		...
		if env_name == "production" or os.getenv("PRODUCTION_MODE", "false").lower() == "true" or os.getenv("PROD", "false").lower() == "true":
			return Environment.PRODUCTION

		# Check for testing indicators
		if env_name == "testing" or os.getenv("TESTING", "false").lower() == "true" or "pytest" in os.environ.get("_", ""):
