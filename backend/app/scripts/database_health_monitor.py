...
class DatabaseHealthMonitor:
    ...
    async def _check_backups(self) -> Dict[str, Any]:
        ...
        try:
            ...
            recent_successful = [
                b for b in recent_backups 
                if b.created_at >= recent_cutoff and b.status.value == "completed"
            ]
        ...
        try:
            ...
            for name, path in directories:
                try:
                    ...
                    warnings.append(f"Could not check {name} disk space: {str(e)}")
    ...
    async def _check_slow_queries(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                "status": "error",
                "message": f"Slow query check failed: {str(e)}",
                "timestamp": datetime.now().isoformat()
            }
    ...
    def generate_report(self, results: Dict[str, Any], format: str = "text") -> str:
        ...
        for check_name, check_result in results["checks"].items():
            ...
            report_lines.extend([
                f"{status_icon} {check_name.upper()}: {check_result['status'].upper()}",
