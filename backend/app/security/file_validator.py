...
class FileSecurityValidator:
    ...
    DANGEROUS_EXTENSIONS = {
        ...
        ".wsf", ".wsh", ".hta", ".cpl", ".msc", ".reg", ".lnk", ".url",
        ".inf", ".ins", ".isp", ".isu", ".job", ".jse", ".ksh", ".mad",
        ".maf", ".mag", ".mam", ".maq", ".mar", ".mas", ".mat", ".mau",
        ".mav", ".maw", ".mcf", ".mda", ".mdb", ".mde", ".mdt", ".mdw",
        ".mdz", ".msc", ".msi", ".msp", ".mst", ".ops", ".pcd", ".pif",
        ".prf", ".prg", ".pst", ".scf", ".scr", ".sct", ".shb", ".shs",
        ".tmp", ".url", ".vb", ".vbe", ".vbs", ".vxd", ".wsc", ".wsf",
        ".wsh", ".xnk", ".application", ".gadget", ".msp", ".mst"
    }
    ...
    async def validate_file(self, file_content: bytes, filename: str) -> FileValidationResult:
        ...
        try:
            ...
            result.threats_detected.append(f"Validation error: {str(e)}")
            result.status = ValidationStatus.INVALID
            return result
