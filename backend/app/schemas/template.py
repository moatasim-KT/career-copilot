...
class TemplateStyling(BaseModel):
    ...
    margins: Dict[str, str] = Field(
        default_factory=lambda: {"top": "1in", "bottom": "1in", "left": "1in", "right": "1in"},
        description="Page margins"
    )
    colors: Dict[str, str] = Field(
        default_factory=lambda: {"primary": "#000000", "accent": "#333333"},
        description="Color scheme"
    )
    spacing: Dict[str, str] = Field(
        default_factory=lambda: {"line_height": "1.2", "paragraph_spacing": "6pt"},
...
class DocumentTemplateCreate(DocumentTemplateBase):
    ...
    template_styles: Optional[str] = Field(None, description="CSS styles for the template")
...
class DocumentTemplateUpdate(BaseModel):
    ...
    description: Optional[str] = Field(None, description="Template description")
    template_structure: Optional[TemplateStructure] = Field(None, description="Template structure")
    template_content: Optional[str] = Field(None, description="HTML template content")
    template_styles: Optional[str] = Field(None, description="CSS styles")
    category: Optional[str] = Field(None, description="Template category")
...
class DocumentTemplate(DocumentTemplateBase):
    ...
    template_styles: Optional[str] = None
