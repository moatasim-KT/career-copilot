"""
from ...core.service_integration import dict
...
async def register_service(service_create: ServiceCreate, registry: ServiceRegistry = Depends(get_service_registry)):
...
async def get_service(service_id: str, registry: ServiceRegistry = Depends(get_service_registry)):
...
async def update_service(service_id: str, service_update: ServiceUpdate, registry: ServiceRegistry = Depends(get_service_registry)):
...
async def unregister_service(service_id: str, registry: ServiceRegistry = Depends(get_service_registry)):
