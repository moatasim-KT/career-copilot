...
async def get_communication_metrics(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get communication metrics: {str(e)}")
...
async def get_system_components(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get system components: {str(e)}")
...
async def test_end_to_end_integration(
    ...
    try:
        ...
        test_contract_data = {
            ...
            "parties": [
                {"name": "Test Corporation", "role": "employer"},
