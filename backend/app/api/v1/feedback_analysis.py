...
async def list_ab_tests(
    ...
    return {
        "status": "success",
        "data": {
            "ab_tests": engine.ab_test_configs,
...
async def stop_ab_test(
    ...
    return {
        "status": "success",
        "message": f"A/B test '{test_name}' stopped"
    }


@router.get("/user-algorithm-info")
async def get_user_algorithm_info(
...
async def get_feedback_impact(
    ...
    active_tests = {
        name: config for name, config in engine.ab_test_configs.items()
    ...
    return {
        ...
        "data": {
            ...
            "active_experiments": {
                "ab_tests_running": len(active_tests),
                "tests": active_tests
            },
