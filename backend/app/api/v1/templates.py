...
from app.schemas.template import (
    ...
    GeneratedDocument, GeneratedDocumentCreate, TemplateGenerationRequest,
    TemplateListResponse, TemplateSearchFilters, TemplateAnalysis,
    TemplateUsageStats, TEMPLATE_TYPES, TEMPLATE_CATEGORIES
)
...
async def get_template_generated_documents(
    ...
    documents, total = service.get_user_generated_documents(
        current_user.id, template_id=template_id, page=page, per_page=per_page
    )
...
async def get_generated_documents(
    ...
    service = TemplateService(db)
    documents, total = service.get_user_generated_documents(
        current_user.id, template_id=template_id, job_id=job_id, page=page, per_page=per_page
    )
