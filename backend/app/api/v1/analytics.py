"""
Analytics API endpoints for comprehensive job application tracking and analysis.

This is the canonical analytics API implementation for the Career Copilot platform.
All analytics-related endpoints are consolidated here.

Features:
- Job application analytics and metrics
- Success rate analysis and trends
- Interview tracking and insights
