...
from fastapi import APIRouter, File, UploadFile, HTTPException, Depends, BackgroundTasks, Request, WebSocket, WebSocketDisconnect
...
async def upload_chunk(
    ...
    chunk_index: int,
    chunk_hash: str,
    file: UploadFile = File(..., description="File chunk to upload"),
...
async def simple_upload(
    file: UploadFile = File(..., description="Contract file to upload"),
