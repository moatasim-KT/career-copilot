...
async def test_build_search_url(adzuna_scraper):
    ...
    expected_url_part = (
        "https://api.adzuna.com/v1/api/jobs/search/us/?app_id=test_app_id&app_key=test_app_key&results_per_page=50&what=software engineer&where=london&country=us&content-type=application/json&page=1"
    )
