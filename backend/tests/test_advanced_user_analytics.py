...
def test_advanced_user_analytics():
	...
	try:
		...
		insights = advanced_user_analytics_service._generate_performance_insights(test_benchmarks, {"success_rates": {"overall_success": 5.0}})
		...
		recommendations = advanced_user_analytics_service._generate_performance_recommendations(
			test_benchmarks_with_improvement, {"success_rates": {"overall_success": 2.0}}
		)
