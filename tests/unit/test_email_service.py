...
from app.services.email_service import EmailService, EmailServiceConfig, EmailProvider, EmailPriority, EmailEventType, EmailTemplate, UnifiedEmailMessage
...
class TestEmailService:
    ...
    async def test_get_delivery_status(self, email_service):
        ...
        email_service.events[tracking_id] = [
            MagicMock(event_type=EmailEventType.SEND, recipient="test@example.com", provider=EmailProvider.SMTP, timestamp=datetime.now() - timedelta(minutes=5)),
