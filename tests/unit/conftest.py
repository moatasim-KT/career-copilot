...
def mock_analytics_data():
	...
	return {
		...
		"data": {"trend": "increasing", "confidence": 0.95, "metrics": {"applications": 50, "responses": 25, "interviews": 10}},
		"metadata": {"source": "automated_analysis", "version": "1.0"},
	}
...
def mock_reporting_service():
	...
	service = Mock(spec=AnalyticsReportingService)

	# Configure common mock behaviors
	service.generate_career_insights.return_value = {"progression_trend": "advancing", "primary_level": "senior"}

	service._analyze_salary_trend_progression.return_value = {"trend_direction": "increasing", "trend_percentage": 7.5}

	service.validate_data_accuracy.return_value = {"mape": 3.5, "rmse": 8.0, "accuracy_score": 0.97}
...
async def async_reporting_service():
	...
	service = AsyncMock(spec=AnalyticsReportingService)
