...
class APITestConfig:
    ...
    @classmethod
    def get_test_headers(cls, user_id: str = None) -> Dict[str, str]:
    ...
    @classmethod
    def get_test_user(cls, user_id: str = None) -> Dict[str, Any]:
        """Get test user data."""
        if user_id is None:
    ...
    @classmethod
    def get_test_job(cls, job_id: str = None) -> Dict[str, Any]:
        """Get test job data."""
        if job_id is None:
...
def create_test_headers(user_id: str = None):
