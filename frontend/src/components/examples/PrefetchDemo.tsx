...
export function ApplicationsListWithPrefetch() {
  ...
  const { reset } = usePrefetchOnScroll({
    onPrefetch: async () => {
      // Prefetch next page
      console.log('Prefetching next page on scroll:', page + 1);
      setPage(p => p + 1);
    },
    threshold: 0.8,
    enabled: true,
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="p-6 bg-blue-50 dark:bg-blue-950 rounded-lg">
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li>✅ <strong>Next Page Prefetch:</strong> Next page is prefetched when you're near the end of the current page</li>
