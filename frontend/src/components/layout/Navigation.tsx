      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-2 flex-shrink-0">
            ...
            <Link href="/dashboard" className="text-xl font-bold text-neutral-900 hidden sm:block">
              Career Copilot
            </Link>
            <Link href="/dashboard" className="text-lg font-bold text-neutral-900 sm:hidden">
              CC
            </Link>
          </div>
