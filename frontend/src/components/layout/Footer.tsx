        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 sm:col-span-2 lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-lg font-bold text-neutral-900">Career Copilot</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center space-y-2 sm:space-y-0 sm:space-x-4">
              <a
                ...
                className="flex items-center space-x-2 text-neutral-500 hover:text-blue-600 transition-colors"
              >
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <span className="text-sm text-neutral-600 hover:text-blue-600 cursor-pointer transition-colors">
                  Job Tracking
                </span>
              </li>
              <li>
        ...
        <div className="border-t border-neutral-200 pt-6 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="flex items-center space-x-2">
              <span className="text-sm text-neutral-500">© {currentYear} Career Copilot</span>
              <Heart className="h-4 w-4 text-red-500" />
              <span className="text-sm text-neutral-500">Built for job seekers</span>
            </div>
            <div className="flex items-center space-x-6">
              <span className="text-sm text-neutral-500 hover:text-blue-600 cursor-pointer transition-colors">
                Terms of Service
              </span>
              <span className="text-sm text-neutral-500 hover:text-blue-600 cursor-pointer transition-colors">
                Privacy Policy
