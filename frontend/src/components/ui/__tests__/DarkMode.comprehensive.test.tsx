...
function getComputedColor(element: Element, property: string) {
...
function hasDarkModeClasses(element: Element) {
...
describe('Dark Mode - Modal Component', () => {
  ...
  it('should render modal in dark mode', () => {
    document.documentElement.classList.add('dark');
    renderWithProviders(
      <Modal2 open={true} onClose={() => { }} title="Test Modal">
        <p>Modal content</p>
      </Modal2>
    );
...
describe('Dark Mode - Drawer Component', () => {
  ...
  it('should render drawer in dark mode', () => {
    document.documentElement.classList.add('dark');
    renderWithProviders(
      <Drawer2 open={true} onClose={() => { }} title="Test Drawer">
        <p>Drawer content</p>
      </Drawer2>
    );
